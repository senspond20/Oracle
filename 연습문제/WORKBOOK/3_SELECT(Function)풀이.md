...
SELECT EXTRACT(YEAR FROM ENTRANCE_DATE) A, 
       EXTRACT(YEAR FROM TO_DATE(SUBSTR(STUDENT_SSN, 1, 6))) B,
       STUDENT_SSN C --EXTRACT(YEAR FROM TO_DATE(SUBSTR(STUDENT_SSN, 1, 6)
FROM TB_STUDENT;
